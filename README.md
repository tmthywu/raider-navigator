# raider-navigator
An interactive kiosk to help the user navigate Richmond Hill High School’s building. Graphically displays the shortest route from any Room A to Room B in the school. Built in Java Swing. This was my ICS3U6 final project.
